...
public class BufMgr implements GlobalConst {
    ...
    public int pageLoadHits;
    public int totPageHits;
    public int totPageRequests=-1;
    public int pageLoadRequests=-1;
    public float pageLoadBHR;
    public float aggregateBHR;
...
//-------------------------------------------------------------
    ...
    public void freePage(PageId pageno)
    {
        ...
        if(tempfd != null)
        {
            ...
            tempfd.pageno.pid = INVALID_PAGE;
            tempfd.pincnt = 0;
            tempfd.dirty = false;
            tempfd.state = Rando.AVAILABLE;
    ...
    {
        //the frame descriptor as the page is in the buffer pool
        int index_value = Integer.valueOf(pageno.pid);
        FrameDesc tempfd = pagemap.get(Integer.valueOf(pageno.pid));
        if(tempfd != null)
        {
